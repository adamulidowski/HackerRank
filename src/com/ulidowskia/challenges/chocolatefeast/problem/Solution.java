package com.ulidowskia.challenges.chocolatefeast.problem;
...
public class Solution {
    ...
    static int chocolateFeast(int n, int c, int m) {
        int chocolates = n / c;
        int eatenChocolates = chocolates;
        int additionalChocolates = 0;
        while (chocolates >= m) {
            additionalChocolates += 1;
            chocolates = (chocolates - m) + 1;
        }
        return eatenChocolates + additionalChocolates;
    }
